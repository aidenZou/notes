...
- [通往全栈工程师的捷径 —— react - 腾讯 bugly - 博客园](http://www.cnblogs.com/bugly/p/4988842.html)
...
- [Router]()
- [graphql](http://graphql.org/) - [Graphcool](https://www.graph.cool/) GraphQL Backend Development Framework
- [relay]()
- [UmiJS](https://github.com/umijs/umi) 极快的类 Next.js 的 React 应用框架。
- [Immutable](https://github.com/facebook/immutable-js/) [Immutable](https://facebook.github.io/immutable-js/) [搞定 immutable.js](https://boke.io/immutable-js/) - [Immutable 详解及 React 中实践](https://segmentfault.com/a/1190000003910357)

- [Redux](https://github.com/reactjs/redux) [Redux 中文文档](http://cn.redux.js.org/) - [redux-thunk](https://github.com/gaearon/redux-thunk) - [redux-promise](https://github.com/acdlite/redux-promise) - [redux-saga](http://yelouafi.github.io/redux-saga)
- [mobx](https://github.com/mobxjs/mobx) - [MobX 中文文档](https://cn.mobx.js.org/) 19071
- [dva](https://github.com/dvajs/dva)
- graphql + apollo
- [mobx-state-tree](https://github.com/mobxjs/mobx-state-tree) 4197
- [rematch](https://github.com/rematch/rematch) 5234
- [xstate](https://github.com/davidkpiano/xstate) 5253
- [Mirror](https://github.com/mirrorjs/mirror) 1314
- [unstated](https://github.com/jamiebuilds/unstated)
- [freactal](https://github.com/FormidableLabs/freactal/)
- [bbx](https://github.com/bbxjs/bbx) 𝕓𝕓𝕩 是一个极其简单高效的 React 状态管理方式
- [retalk](https://github.com/nanxiaobei/retalk) 69
- [react-control-center](https://github.com/fantasticsoul/react-control-center)
- [stamen](https://github.com/forsigner/stamen) 92
- [react-coat](https://github.com/wooline/react-coat) 219
- [smox](https://github.com/132yse/smox) 328 ![star](https://ghbtns.com/github-btn.html?user=132yse&repo=smox&type=star&count=true)
- [Dob](https://github.com/dobjs/dob) 614
